...
import com.spring.projectplanner.services.ProjectTaskService;
...
public class BacklogController {
    ...
    public ResponseEntity<?> deleteProjectTask(@PathVariable String backlog_id, @PathVariable String pt_id) {
        ...
        return new ResponseEntity<String>("Project Task with ID: " + pt_id + " sucessfully deleted!!", HttpStatus.OK);
    }
